...
test_that("format_bloodmeal_profiles works", {
  ...
  expect_message(expect_message(expect_equal(format_bloodmeal_profiles(filter_peaks(bloodmeal_profiles, 3000)),
               list(evid1 = list(D2S441 = list(adata = c("10", "14"), hdata = c(3362, 3693))))),
